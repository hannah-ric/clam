...
function downloadTemplate(){
  ...
  const csv=
    "name,brand,latitude,longitude,asset_value_usd,country,annual_revenue_usd,construction,year_built,defended,roof_type,roof_year,opening_protection,first_floor_elev_m,equipment_elevated,wui_class,defensible_space_m,roof_class_a,archetype,named_insured,site_id,site_name\n"+
    "Example Beachfront Resort,Club Wyndham,27.9500,-82.4600,40000000,USA,14000000,masonry,2002,false,metal,2018,impact,1.2,true,,,,beachfront_lowrise,HOA,CAMPUS-BEACH,Example Beachfront Resort\n"+
    "Example Beachfront Resort,Club Wyndham,27.9500,-82.4600,12000000,USA,,masonry,2002,false,metal,2018,impact,1.2,true,,,,tower_concrete,Operating company,CAMPUS-BEACH,Example Beachfront Resort\n"+
    "Example Inland Resort,WorldMark,29.4241,-98.4936,22000000,USA,,frame,2005,,shingle,2005,none,,,intermix,10,false,lowrise_timber,,,\n"+
