...
#   4. app lineage           (v1.5 -> patch chain -> v1.13 must reproduce the
#                             committed v1.6 and v1.13 files byte for byte)
...
rm -f pipeline/sim_hazard_grid.csv pipeline/sim_hazard_grid_meta.json \
      ...
      pipeline/sim_badfire_grid.csv pipeline/sim_cov_sites.csv \
