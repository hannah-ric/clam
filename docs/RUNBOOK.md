...
Current deployable: `app/Resort_Climate_Risk_Explorer_v210.html` (assembled from
...
patch_frontend.py : produces the v1.6 app from the v1.5 HTML (5 surgical
  ...
  app/Resort_Climate_Risk_Explorer_v210.html (assembled from app/src/).
  Resort_Climate_Risk_Explorer_v16.html remains as a lineage checkpoint.
